-- =========================================================================================
-- 00023: Drop overloaded reserve_stream_slot variants to eliminate signature ambiguity
-- =========================================================================================

DROP FUNCTION IF EXISTS public.reserve_stream_slot(UUID, TEXT);
DROP FUNCTION IF EXISTS public.reserve_stream_slot(UUID, UUID);
